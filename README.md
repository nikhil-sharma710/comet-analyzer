...
Yay! Now that the user has deployed the application, made sure their images and containers are functional, and confirmed a successful pytest, they may begin interacting with the application.
